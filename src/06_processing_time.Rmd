...
let's clip the tree list to the study bounds for each result for using with LANL TREES and Quic-Fire

```{r}
# dir
dir_temp <- file.path("../data", "cloud2trees_processed_tree_lists")
